...
# =============================================================================
# Benchmark Script for vLLM Disaggregated Serving with P2P NCCL - HF InstructCoder Dataset
# =============================================================================
...
DATASET_PATH=${DATASET_PATH:-likaixin/InstructCoder}
...
# Main execution
main() {
    echo "Starting benchmark script for P2P NCCL configuration with HF InstructCoder dataset..."
